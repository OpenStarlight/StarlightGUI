...
#define SIRIUS_DRIVER_VERSION L"8.0.0-beta"
#if defined(_M_IX86)
...
#define IOCTL_SIRIUS_SCRIPT_EXECUTE            CTL_CODE(FILE_DEVICE_UNKNOWN, 0x703, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define SI_SCRIPT_MAX_SIZE 8192
#define SI_SCRIPT_OUTPUT_SIZE 4096

typedef struct _SI_SCRIPT_EXECUTE {
    WCHAR Script[SI_SCRIPT_MAX_SIZE];
} SI_SCRIPT_EXECUTE, *PSI_SCRIPT_EXECUTE;
